#!/usr/bin/env python3
"""Auto-generated workflow execution wrapper for: Claude Headroom Setup"""
...
COMMANDS = ["headroom wrap claude", "headroom wrap claude -- --model claude-sonnet-4-6", "headroom doctor", "headroom perf", "adwi/.venv/bin/python3 adwi/scripts/validate_claude_headroom.py", "adwi/.venv/bin/python3 adwi/scripts/claude_headroom_status.py", "git status", "git diff"]
WORKFLOW_NAME = "Claude Headroom Setup"
SOURCE_NOTE = "/Users/MAC/SuneelWorkSpace/brain/knowledge/Claude Headroom Setup.md"
...
[RESULT]")
    ...
    try:
        ...
        quality_score = record_outcome(
            workflow_slug="claude_headroom_setup",
            success=success,
