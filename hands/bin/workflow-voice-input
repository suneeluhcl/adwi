#!/usr/bin/env python3
"""Auto-generated workflow execution wrapper for: Voice Input"""
...
COMMANDS = ["Add a `--voice` flag to `bin/adwi` that launches with `/listen` active by default"]
WORKFLOW_NAME = "Voice Input"
SOURCE_NOTE = "/Users/MAC/SuneelWorkSpace/brain/projects/ideas/Voice Input.md"
