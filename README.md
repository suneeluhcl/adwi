...
| 3 | LLM classification | `llama3.1:8b` with JSON schema — `analysis`+`confidence`+`intent`+`arguments` (87 intent classes) |
...
- `intent` — one of 87 registered intent classes
...
<!-- AUTO:COMMANDS -->
**147 registered commands.** Key groups:
